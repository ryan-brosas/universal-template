#!/usr/bin/env python3
"""reference-retrieval-fixture.py — behavioral proxy for reference discovery wiring.

Checks that policy surfaces (project-bootstrap inventory, RDD retrieval
description) exist so an agent can notice project-local references without
