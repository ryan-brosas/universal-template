...
Do not edit files, rewrite history, or claim checks you did not run. If CodeRabbit
is explicitly requested, load `coderabbit-review` from the installed skill catalog; otherwise do not
add an external review or upload step.
