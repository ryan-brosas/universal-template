# Compile session evidence into durable improvements

Run the full session-improvement compiler so the user does not need to restate the recall, reflection, classification, and promotion workflow.
...
6. Route objective regressions into deterministic checks, not prose alone.
7. Because this command is an explicit promotion request, implement qualified improvements, run all affected validation and behavior tests, and report what was deliberately not saved.
8. If nothing qualifies, change nothing and explain why.

## Report

    Scope and evidence used:
    Hindsight/Fabric contribution:
    Contradictions and uncertainty:
    Classification decisions:
    Existing owners improved:
