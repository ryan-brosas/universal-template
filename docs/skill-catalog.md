...
|---|---|---|---|
| [`api-and-interface-design`](../skills/api-and-interface-design/SKILL.md) | entry | visible | Use when designing REST/GraphQL APIs, SDK interfaces, or public module boundaries - covers contract-first design, versioning, error shapes, and backward compat... |
| [`brainstorming`](../skills/brainstorming/SKILL.md) | entry | visible | Use when a rough idea needs clarification before implementation - resolve ambiguous direction by grounding in what exists, framing the problem, exploring real... |
...
| [`coding-best-practices`](../skills/coding-best-practices/SKILL.md) | entry | visible | Use when the user explicitly asks for engineering standards, coding best practices, quality guidance, or help selecting a quality procedure or leaf skill - rou... |
...
| [`veda-lane`](../skills/veda-lane/SKILL.md) | internal | hidden | Use when a task justifies a Veda lane (navigator-plan, reviewer, worker, or deep thinking) - probe availability at runtime, discover models with veda models, d... |
...
| Skill | Class | Visible | Description |
|---|---|---|---|
| [`android-coding-practices`](../skills/android-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Android apps - ribot/xmartlabs resource naming, component factories, Java/Kotlin conventions, MVP/Jetpack layering, and lint/de... |
| [`angular-coding-practices`](../skills/angular-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Angular apps - kebab-case files, feature folders, inject(), readonly inputs, protected template members, class/style bindings,... |
| [`api-design-practices`](../skills/api-design-practices/SKILL.md) | cold | hidden | Use when designing or reviewing HTTP/JSON APIs - resource naming, idempotent writes, machine-readable errors, pagination from v1, and explicit versioning; dist... |
...
| [`arduino-coding-practices`](../skills/arduino-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Arduino libraries/sketches - camelCase read/write/begin API, .h/.cpp structure, setup/loop lifecycle, Stream-aware serial, keyw... |
...
| [`c-coding-practices`](../skills/c-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing C - snake_case naming, header guards, no data in headers, Yoda comparisons, safe macros, initialize-all, and checked error retu... |
| [`clojure-coding-practices`](../skills/clojure-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Clojure - 2-space layout, gathered parens, sorted ns requires, lisp-case naming, ?/! conventions, threading idioms, keyword map... |
| [`cloudflare`](../skills/cloudflare/SKILL.md) | cold | hidden | Use when deploying to or configuring ANY Cloudflare service - Workers, Pages, KV, D1, R2, AI, Tunnel, WAF. MUST load before writing Cloudflare Workers code, wr... |
| [`common-lisp-coding-practices`](../skills/common-lisp-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Common Lisp - lisp-case naming, *earmuffs*/+constants+, SLIME indentation, :import-from packages, CLOS typed slots, defgeneric... |
| [`cpp-coding-practices`](../skills/cpp-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing C++ - self-contained headers, IWYU, PascalCase/snake_case naming, unique_ptr ownership, RAII, explicit conversions, and clang-f... |
...
| [`d-coding-practices`](../skills/d-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing D - 4-space Allman layout, camelCase/PascalCase naming, alias= declarations, @property APIs, selective imports, Ddoc Params/Ret... |
| [`dart-coding-practices`](../skills/dart-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Dart - dart format, UpperCamelCase/lowerCamelCase naming, /// documentation, null-safe idioms, async/await, typed public API, c... |
...
| [`django-coding-practices`](../skills/django-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Django code - black/isort imports, DTL spacing, request-first views, model field order, TextChoices, lazy settings, i18n string... |
| [`dotnet-coding-practices`](../skills/dotnet-coding-practices/SKILL.md) | cold | hidden | Use when designing or reviewing cross-language .NET public APIs - Framework Design naming, scenario-driven library design, exception/event/dispose patterns, se... |
| [`drupal-coding-practices`](../skills/drupal-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Drupal modules/themes - 2-space PHP layout, module-prefixed functions, PSR-4 namespaces, docblocks, t() i18n, YAML/Twig/JS stan... |
| [`elixir-coding-practices`](../skills/elixir-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Elixir - mix format, snake_case/CamelCase naming, module attribute order, pipelines, @moduledoc/@spec, Error exceptions, and mi... |
...
| [`haskell-coding-practices`](../skills/haskell-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Haskell - 4-space/80-col layout, Haddock, explicit imports, type signatures, avoid partial functions, strict data, IO separatio... |
| [`httpd-c-coding-practices`](../skills/httpd-c-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Apache httpd C - 4-space 80-col layout, GNU indent profile, ANSI function/control-flow spacing, httpd cast rules, rationale com... |
| [`java-coding-practices`](../skills/java-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Java - google-java-format layout, import discipline, Google naming, @Override, handled catches, static qualification, and Javad... |
| [`javascript-coding-practices`](../skills/javascript-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing JavaScript - named ES module exports, const/let, strict equality, semicolons and braces, trailing commas, arrow callbacks, JSDo... |
| [`javascript-project-practices`](../skills/javascript-project-practices/SKILL.md) | cold | hidden | Use when bootstrapping or reviewing JavaScript/Node projects - elsewhen git/PR workflow, README template, env config, lockfiles, feature folders, ESLint/Pretti... |
| [`json-api-practices`](../skills/json-api-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing JSON API payloads - strict JSON syntax, camelCase properties, string enums, RFC3339 dates, Google-style data/error envelope, an... |
| [`julia-coding-practices`](../skills/julia-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Julia - BlueStyle/JuliaFormatter 4-space/92-col layout, explicit using/exports, typed methods with return, kwargs semicolon, do... |
| [`kotlin-coding-practices`](../skills/kotlin-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Kotlin - 4-space layout, PascalCase/camelCase naming, package-aligned files, class member order, val immutability, default para... |
| [`linux-kernel-coding-practices`](../skills/linux-kernel-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Linux kernel C - 8-tab indent, 80-col K&R braces, pointer-on-name spacing, descriptive globals, goto cleanup, kernel-doc, kmall... |
| [`lua-coding-practices`](../skills/lua-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Lua - local-first modules, 2–4 space layout, snake_case/CamelCase naming, return-M pattern, guard returns, table/LDoc idioms, a... |
| [`magento-coding-practices`](../skills/magento-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Adobe Commerce/Magento extensions - strict_types, PSR-12, ::class, DI/composition, prepared SQL, escape output, service contrac... |
| [`mailchimp-content-practices`](../skills/mailchimp-content-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing product/marketing copy - Mailchimp plainspoken voice, active positive language, inclusive people terms, sentence-case UI headin... |
| [`markdown-writing-practices`](../skills/markdown-writing-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Markdown docs - single H1 layout, 80-column wrap, ATX headings, fenced code with language, descriptive links, reference links,... |
| [`mdn-code-examples-practices`](../skills/mdn-code-examples-practices/SKILL.md) | cold | hidden | Use when authoring MDN/Mozilla doc code examples - Prettier, 15–25 line vanilla snippets, JS const/let/textContent, HTML5 lowercase kebab markup, modern vanill... |
...
| [`nim-coding-practices`](../skills/nim-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Nim - NEP-1 2-space/80-col layout, PascalCase/camelCase naming, init/new and abbrev API vocabulary, result-first procs, std/ im... |
| [`node-coding-practices`](../skills/node-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Node.js - felixge 2-space semicolons, camelCase/===, small early-return functions, top requires, npm/package.json, PORT env, an... |
...
| [`objc-coding-practices`](../skills/objc-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Objective-C - Google/GitHub layout, 3+ char prefixes, property/copy semantics, designated initializers, Doxygen docs, NSError e... |
| [`october-coding-practices`](../skills/october-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing October CMS plugins/themes - PSR-1/2/4, camelCase/snake_case split, marketplace naming, Rain exceptions, composer -plugin/-them... |
| [`pascal-coding-practices`](../skills/pascal-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Free Pascal/GNU Pascal - 2-space/no-tab layout, lowercase keywords, PascalCase T/P types, unit block order, brace comments, res... |
| [`pdf-extract`](../skills/pdf-extract/SKILL.md) | cold | hidden | Use when extracting text, images, tables, or metadata from PDF files. MUST load to choose the correct extraction library based on PDF complexity - simple text... |
| [`perl-coding-practices`](../skills/perl-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing Perl - v5.36/strict/warnings, 4-space aligned layout, snake_case and Mixed::Case modules, 3-arg open, explicit subs/I/O, anti-p... |
| [`php-coding-practices`](../skills/php-coding-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing PHP - PSR-12 layout, PSR-1/PSR-4 file hygiene, strict_types, identical comparison, typed APIs, visibility, final classes, and c... |
...
| [`sql-scripting-practices`](../skills/sql-scripting-practices/SKILL.md) | cold | hidden | Use when authoring or reviewing SQL - snake_case naming, uppercase keywords, river-aligned layout, portable DDL types, suffix conventions, and parameterized qu... |
...
| [`wcag-accessibility-practices`](../skills/wcag-accessibility-practices/SKILL.md) | cold | hidden | Use when auditing or building web UI for WCAG 2.1 Level AA - POUR success criteria, keyboard/focus, contrast/reflow, forms/errors, name-role-value, and axe plu... |
...
| Skill | Class | Visible | Description |
|---|---|---|---|
| [`veda-deep-plan`](../skills/veda-deep-plan/SKILL.md) | vendor | visible | Use when a single planning call is not enough - architectural design, subtle bugs with no obvious cause, decisions with no clear answer: plan the hardest probl... |
| [`veda-plan`](../skills/veda-plan/SKILL.md) | vendor | visible | Big-model planning lane. Produce an implementation-ready Architect plan + program design (design.json), then complete a self-contained HTML design doc (devdocs... |
