...
Some work genuinely needs a durable coordination contract — a migration that spans days, a risky architecture change, cross-agent or cross-team execution. Goal setup captures exactly that contract in ONE artifact; it never manufactures planning ceremony for ordinary work.
