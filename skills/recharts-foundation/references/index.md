...
- `./nice-ticks-adaptive-step.md` — how a rough step is rounded up onto a magnitude grid (0.05/0.1 ratio quantization), the default `StepFunction`.
- `./nice-ticks-snap125-step.md` — the opt-in {1,2,2.5,5}×10ⁿ ladder, exact-member epsilon guard, and correctionFactor-as-index semantics.
- `./nice-ticks-calculate-step.md` — middle anchoring (0 is always a tick), zero-straddle ≥3 lift, and the correctionFactor recursion that converges tick count.
- `./nice-ticks-domain-guards.md` — ±Infinity sentinel fills, single-value delegation, reversed-domain output reversal, and the 0.1·step rangeStep pad.
- `./nice-ticks-single-value.md` — min===max centered tick fans across decimals/integers/zero branches.
- `./nice-ticks-fixed-domain.md` — clamped variant: forced boundary append, post-round integer dedupe, short-circuit guards.
- `./nice-ticks-decimal-arithmetic.md` — Decimal-walk rangeStep with infinite-loop fuse; signed digit counts powering both step algorithms.
- `./nice-ticks-mode-dispatch.md` — combineNiceTicks three-arm funnel: none/auto-keyword/explicit modes → which generator runs.
- `./nice-ticks-domain-widening.md` — how tick extremes grow the rendered domain, with the unexplained angle-axis exemption.
- `./ticks-value-to-coordinate.md` — combineAxisTicks five-level precedence and band/angle offset quirks (#4271).
- `./ticks-collision-filtering.md` — getTicks interval modes, direction sign from first coordinates, lazy DOM size measurement.
- `./ticks-equidistant-search.md` — restart-vs-offset asymmetry between preserveStart and preserveEnd equidistant searches.
- `./ticks-visibility-primitives.md` — isVisible/getTickBoundaries/getEveryNth signed-space algebra shared by every filter.
- `./scale-resolution-wrapper.md` — string/'auto'/function scale resolution into the immutable RechartsScale wrapper (.map band positioning).
- `./scale-categorical-inverse.md` — bisect-based nearest-category inversion supporting descending arrays, with data-point override.
- `./axis-size-oscillation-latch.md` — ABA ring-history latch that freezes measured axis sizes to break render loops.
...
- [`axis-size-oscillation-latch.md`](./axis-size-oscillation-latch.md)
- [`nice-ticks-adaptive-step.md`](./nice-ticks-adaptive-step.md)
- [`nice-ticks-calculate-step.md`](./nice-ticks-calculate-step.md)
- [`nice-ticks-decimal-arithmetic.md`](./nice-ticks-decimal-arithmetic.md)
- [`nice-ticks-domain-guards.md`](./nice-ticks-domain-guards.md)
- [`nice-ticks-domain-widening.md`](./nice-ticks-domain-widening.md)
- [`nice-ticks-fixed-domain.md`](./nice-ticks-fixed-domain.md)
- [`nice-ticks-mode-dispatch.md`](./nice-ticks-mode-dispatch.md)
- [`nice-ticks-single-value.md`](./nice-ticks-single-value.md)
- [`nice-ticks-snap125-step.md`](./nice-ticks-snap125-step.md)
- [`scale-categorical-inverse.md`](./scale-categorical-inverse.md)
- [`scale-resolution-wrapper.md`](./scale-resolution-wrapper.md)
- [`ticks-collision-filtering.md`](./ticks-collision-filtering.md)
- [`ticks-equidistant-search.md`](./ticks-equidistant-search.md)
- [`ticks-value-to-coordinate.md`](./ticks-value-to-coordinate.md)
- [`ticks-visibility-primitives.md`](./ticks-visibility-primitives.md)
