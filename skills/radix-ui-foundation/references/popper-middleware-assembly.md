...
**Probe:** direct tests `packages/react/popper/src/popper.test.tsx` (295L). Byte-exact anchors: `bash -c "cd /mnt/hdd/utopia/inspo/external/ui-radix-ui && grep -nF \"strategy: 'fixed',\" packages/react/popper/src/popper.tsx"` (:229) and `grep -nF 'boundary: hasExplicitBoundaries ? detectOverflowOptions.boundary : undefined,' packages/react/popper/src/popper.tsx"` (:275).
**Retrieve:**
```ts
