...
**Probe:** direct tests `packages/react/focus-scope/src/focus-scope.test.tsx` (309L suite). Byte-exact anchors: `bash -c "cd /mnt/hdd/utopia/inspo/external/ui-radix-ui && grep -nF 'if (relatedTarget === null) return;' packages/react/focus-scope/src/focus-scope.tsx"` (:130) and `grep -nF \"item.tagName !== 'A'\" packages/react/focus-scope/src/focus-scope.tsx"` (:455 removeLinks).
**Retrieve:**
```ts
