...
- `./versioned-frame-validation.md` — how must every frame be validated before dispatch?
- `./rpc-pending-abort-hygiene.md` — how are outbound requests correlated, aborted, and torn down without leaks?
- `./log-redaction-failure-classification.md` — what may safely reach logs, and how do failures become category/code/retryable triples?
- `./group-intact-compaction-budget.md` — when does history compact and what is never split or accumulated?
- `./manual-compaction-rpc.md` — how does on-demand history.compact force-shrink without starting a run, and survive summarizer failure?
- `./run-lifecycle-accept-settle.md` — what does the host see between run.start and a terminal event?
- `./identity-question-short-circuit.md` — which inputs answer without any model call?
- `./auto-model-reasoning-wire.md` — how does one stream serve Auto-model selection and two reasoning field dialects?
- `./host-tool-execution-error-split.md` — which tool failures are terminal and which go back to the model for self-correction?
- `./notion-preflight-cache-binding.md` — how does an approval preview stay bound to its exact callId across concurrency, pauses, and pruning?
- `./sdk-stream-delta-forwarding.md` — which SDK events surface as reasoning/message deltas and which die silently?
- `./engine-result-history-projection.md` — how are SDK history/usage blobs projected to the wire schema without throwing?
- `./interruption-envelope-resume.md` — how do approvals survive process death and resume exactly once?
- `./process-lifecycle-shutdown.md` — how does the child boot, refuse work while dying, and crash honestly?
...
- [`auto-model-reasoning-wire.md`](./auto-model-reasoning-wire.md)
- [`engine-result-history-projection.md`](./engine-result-history-projection.md)
- [`group-intact-compaction-budget.md`](./group-intact-compaction-budget.md)
- [`host-tool-execution-error-split.md`](./host-tool-execution-error-split.md)
- [`identity-question-short-circuit.md`](./identity-question-short-circuit.md)
- [`interruption-envelope-resume.md`](./interruption-envelope-resume.md)
- [`log-redaction-failure-classification.md`](./log-redaction-failure-classification.md)
- [`manual-compaction-rpc.md`](./manual-compaction-rpc.md)
- [`notion-preflight-cache-binding.md`](./notion-preflight-cache-binding.md)
- [`process-lifecycle-shutdown.md`](./process-lifecycle-shutdown.md)
- [`rpc-pending-abort-hygiene.md`](./rpc-pending-abort-hygiene.md)
- [`run-lifecycle-accept-settle.md`](./run-lifecycle-accept-settle.md)
- [`sdk-stream-delta-forwarding.md`](./sdk-stream-delta-forwarding.md)
- [`versioned-frame-validation.md`](./versioned-frame-validation.md)
