...
## Provenance
Indexed in Codebase Memory as `Roo-Code` (`$REFERENCE_ROOT/Roo-Code`, canonical root `$REFERENCE_ROOT/coding-agents/Roo-Code`), branch `main@b867ec9145750d0ae1ff7f02d35406e9bf2a0b16`, 36,333 nodes / 77,100 edges. Source and tests remain authoritative; the graph is a discovery index.
