...
For repeat in-place revision of existing Foundation Pack sources, use `/learn --auto foundation-pack`; this skill keeps ownership of external-source qualification and approval. For ordinary `go deeper`, resume the approved repository from current source, scoped memory, and any qualified work record. Choose one high-value unresolved seam,
