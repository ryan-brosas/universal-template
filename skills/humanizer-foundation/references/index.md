...
- `./humanize-rewrite-fact-integrity-loop.md` — how does the rewrite loop change prose without drifting a single fact?
- `./pattern-taxonomy-false-positive-boundary.md` — which surface patterns flag AI prose, and what never counts as proof alone?
- `./validator-fail-loud-message-ladder.md` — how does a zero-dependency validator fail first with a message that names the fix?
- `./frontmatter-portability-gate.md` — which YAML frontmatter shape stays portable across agent hosts?
- `./three-way-version-parity-set.md` — how do three files agree on one version with a missing-key trap?
- `./single-skill-shape-gate.md` — what physical package shape survives plugin loaders and symlink incidents?
- `./cross-file-numbering-and-rules-parity.md` — how do skill and README stay number-complete and rule-present without sharing order?
- `./ci-triple-validation-gate.md` — which three independent checks gate a prompt-only repo in CI?
...
- [`ci-triple-validation-gate.md`](./ci-triple-validation-gate.md)
- [`cross-file-numbering-and-rules-parity.md`](./cross-file-numbering-and-rules-parity.md)
- [`frontmatter-portability-gate.md`](./frontmatter-portability-gate.md)
- [`humanize-rewrite-fact-integrity-loop.md`](./humanize-rewrite-fact-integrity-loop.md)
- [`pattern-taxonomy-false-positive-boundary.md`](./pattern-taxonomy-false-positive-boundary.md)
- [`single-skill-shape-gate.md`](./single-skill-shape-gate.md)
- [`three-way-version-parity-set.md`](./three-way-version-parity-set.md)
- [`validator-fail-loud-message-ladder.md`](./validator-fail-loud-message-ladder.md)
