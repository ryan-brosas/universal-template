...
- Understand what a session taught, or answer a history question: use relevant
  session evidence and available history. Reflection and recall are read-only;
  they do not require a particular history provider or authorize changes.
