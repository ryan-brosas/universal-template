---
name: ui-ux-iteration-loop
description: "Use when improving or designing an interface through repeated UI/UX iterations, especially when feedback is vague, a screen looks usable but a task underperforms, or psychology and UI heuristics must become testable design changes rather than decoration."
invocation: entry
---
