...
Application skill for JavaScript style learning (`awesome-guidelines` deep ingest). For TypeScript domain rules, load `typescript-coding-standards`; for React, `react-foundation`.
