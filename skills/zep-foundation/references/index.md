...
- `./episode-validation-contract.md` — what makes a record submittable before any API call?
- `./protocol-extension-surface.md` — how do Loaders/Transforms/Submitters/LLM clients plug in without base classes?
- `./pipeline-warning-lifecycle.md` — collecting per-component warnings across preview+run on reused objects?
- `./validated-replay-spool.md` — full validation of a lazy stream before async consumption?
- `./retry-safety-taxonomy.md` — which failures may be retried, and what makes a retry safe?
- `./batch-rollover-ladder.md` — surviving batch.create failure at page 40 of 50?
- `./auto-dispatch-probe.md` — choosing batch vs sequential without losing the peeked item?
- `./result-resume-handles.md` — recovering an async import from another process?
- `./boundary-splitting-ladder.md` — splitting text/message/json without corrupting shape?
- `./limit-guard-safety-net.md` — the invisible 10k-char episode ceiling?
- `./alias-canonicalizer-rails.md` — rewriting entity names without corrupting prose?
- `./chunk-marker-courtesy.md` — internal diagnostic metadata vs caller domain data?
- `./contextualizer-hardening.md` — LLM chunk-contextualization under untrusted content?
- `./slack-roster-resolution.md` — opaque user IDs to mergeable entity names?
- `./slack-inventory-selection.md` — four conversation indexes, wrapper folders, traversal defense?
- `./slack-thread-grouping.md` — threads as episodes: ordering, dedupe, timestamp stamping?
- `./transcript-turn-parser.md` — speaker turns, VTT cues, header disambiguation?
- `./email-text-timestamp-fidelity.md` — Date headers and mtimes as honest created_at?
- `./json-records-identity-mapping.md` — unified-entity field lifting with provenance reserved?
- `./thread-backfill-ownership.md` — chat-history backfill without cross-user writes?
- `./triples-nodes-seeding.md` — asserting known facts and canonical nodes deterministically?
- `./validation-helpers.md` — shared field guards and the two finiteness regimes?
- `./row-schema-gate.md` — dataclass-derived JSONL row validation?
- `./search-readiness-errors.md` — indexing-lag polling and the error taxonomy?
- `./ontology-prompt-schema.md` — Pydantic docstrings as extraction instructions?
- `./llm-client-adapters.md` — complete(prompt)->str adapters for any provider?
...
- [`alias-canonicalizer-rails.md`](./alias-canonicalizer-rails.md)
- [`auto-dispatch-probe.md`](./auto-dispatch-probe.md)
- [`batch-rollover-ladder.md`](./batch-rollover-ladder.md)
- [`boundary-splitting-ladder.md`](./boundary-splitting-ladder.md)
- [`chunk-marker-courtesy.md`](./chunk-marker-courtesy.md)
- [`contextualizer-hardening.md`](./contextualizer-hardening.md)
- [`email-text-timestamp-fidelity.md`](./email-text-timestamp-fidelity.md)
- [`episode-validation-contract.md`](./episode-validation-contract.md)
- [`json-records-identity-mapping.md`](./json-records-identity-mapping.md)
- [`limit-guard-safety-net.md`](./limit-guard-safety-net.md)
- [`llm-client-adapters.md`](./llm-client-adapters.md)
- [`ontology-prompt-schema.md`](./ontology-prompt-schema.md)
- [`pipeline-warning-lifecycle.md`](./pipeline-warning-lifecycle.md)
- [`protocol-extension-surface.md`](./protocol-extension-surface.md)
- [`result-resume-handles.md`](./result-resume-handles.md)
- [`retry-safety-taxonomy.md`](./retry-safety-taxonomy.md)
- [`row-schema-gate.md`](./row-schema-gate.md)
- [`search-readiness-errors.md`](./search-readiness-errors.md)
- [`slack-inventory-selection.md`](./slack-inventory-selection.md)
- [`slack-roster-resolution.md`](./slack-roster-resolution.md)
- [`slack-thread-grouping.md`](./slack-thread-grouping.md)
- [`thread-backfill-ownership.md`](./thread-backfill-ownership.md)
- [`transcript-turn-parser.md`](./transcript-turn-parser.md)
- [`triples-nodes-seeding.md`](./triples-nodes-seeding.md)
- [`validated-replay-spool.md`](./validated-replay-spool.md)
- [`validation-helpers.md`](./validation-helpers.md)
