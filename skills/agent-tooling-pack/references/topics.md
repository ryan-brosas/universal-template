...
- [autonomous-agent-teams](../../../knowledge/playbooks/autonomous-agent-teams/README.md) — delegation, bounded orchestration, per-agent judgment, task learning, and workspace moves.
- [appflowy-workspace](../../../knowledge/playbooks/appflowy-workspace/README.md) — AppFlowy pages, spaces and database rows via CLI/MCP: identity, auth, uploads, page order and evidence tiers.
