...
- `./plugin-entry-registries.md` — how a plugin fans registry items into addBase/addComponents/addUtilities with include/exclude control.
- `./theme-injection-ladder.md` — turning `themes: ["light --default", "dark --prefersdark"]` into exact base-layer selectors.
- `./nest-css-layers-flatten.md` — hoisting authored `@layer daisyui.l1…` object blocks into Tailwind-callable styles.
- `./cascade-layer-specificity-ladder.md` — controlling override precedence with layer nesting depth instead of `!important`.
- `./selector-prefix-scanner.md` — character-level class/variable prefixing that survives strings, comments, escapes, and attribute selectors.
- `./responsive-variant-pipeline.md` — static `md:`/`lg:` variant generation by recompiling per breakpoint.
- `./wrapper-sandwich-compiler.md` — using Tailwind's `compile()` as a library and slicing your output between sentinel layers.
...
- [`cascade-layer-specificity-ladder.md`](./cascade-layer-specificity-ladder.md)
- [`nest-css-layers-flatten.md`](./nest-css-layers-flatten.md)
- [`plugin-entry-registries.md`](./plugin-entry-registries.md)
- [`responsive-variant-pipeline.md`](./responsive-variant-pipeline.md)
- [`selector-prefix-scanner.md`](./selector-prefix-scanner.md)
- [`theme-injection-ladder.md`](./theme-injection-ladder.md)
- [`wrapper-sandwich-compiler.md`](./wrapper-sandwich-compiler.md)
