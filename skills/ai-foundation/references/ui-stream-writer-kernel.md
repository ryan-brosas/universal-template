...
**Probe:** `bash -c "grep -n 'should support writing from delayed merged streams' /mnt/hdd/utopia/inspo/ai/packages/ai/src/ui-message-stream/create-ui-message-stream.test.ts && grep -c safeEnqueue /mnt/hdd/utopia/inspo/ai/packages/ai/src/ui-message-stream/create-ui-message-stream.ts"` → `:317` and `6`.
