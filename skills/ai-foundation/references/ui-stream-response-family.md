...
**Probe:** `bash -c "grep -n 'x-vercel-ai-ui-message-stream' /mnt/hdd/utopia/inspo/ai/packages/ai/src/ui-message-stream/ui-message-stream-headers.ts && grep -rn 'do not block the response' /mnt/hdd/utopia/inspo/ai/packages/ai/src/ui-message-stream/create-ui-message-stream-response.ts /mnt/hdd/utopia/inspo/ai/packages/ai/src/ui-message-stream/pipe-ui-message-stream-to-response.ts"` → `:5`, `:36` + `:40`.
