...
**Probe:** `bash -c "grep -n \"should convert UI messages to model messages correctly\\|should throw error for invalid messages\\|should return null\" $REFERENCE_ROOT/ai/packages/ai/src/ui/direct-chat-transport.test.ts"` → :318, :404, :427.
