...
- `./pgStep.md` — why AsyncLocalStorage does not reach Workflow steps and the wrapper that fixes it.
- `./run-lifecycle-guards.md` — one active run per config via partial unique index + workflow-status reconciliation.
- `./rank-check-workflow.md` — prepare/batches/finalize state machine that never resurrects superseded runs.
- `./live-queued-check-paths.md` — batch ladders, poll cadence, and the never-abort-a-paid-run rule.
- `./credit-estimation.md` — per-call round-then-ceiling credit math that matches real metering.
- `./schedule-anchor.md` — drift-free computeNextCheckAt advancing from the previous anchor.
- `./scheduled-rank-checks-cron.md` — tick budget/deadline admission control; never write nextCheckAt on errors.
- `./dataforseo-metered-client.md` — lazy section loading behind a meter() proxy with charged-task accounting.
- `./billing-envelope-assert-ok.md` — the status ladder separating access failures from charged-but-failed tasks.
- `./serp-rankcheck-adapter.md` — organic-only position extraction plus stop_crawl_on_match cost control.
- `./billing-error-classifier.md` — balance-failure text/status classifier scoped by API path prefix.
- `./r2-cache-key.md` — sorted-param SHA-256 keys, metadata TTL, zod-validate-on-read.
- `./research-scope-target-parser.md` — domain/URL scope grammar with PSL validation and post-filter matching.
- `./brand-lookup-fanout.md` — sequenced metered calls, settled sub-calls, complete-only caching.
- `./audit-scratchpad-do.md` — SQLite Durable Object frontier with self-healing cleanup alarm.
- `./site-audit-phases.md` — paid-call checkpoint isolation, legacy checkpoint shapes, robots-replay pinning.
- `./mcp-tool-registration.md` — typed tool table, instrumentation wrap, oseo_-scoped API-key lane.
- `./sam-agent-turn-hooks.md` — refusal-as-model gating, per-turn metering, rewind race containment.
...
- [`audit-scratchpad-do.md`](./audit-scratchpad-do.md)
- [`billing-envelope-assert-ok.md`](./billing-envelope-assert-ok.md)
- [`billing-error-classifier.md`](./billing-error-classifier.md)
- [`brand-lookup-fanout.md`](./brand-lookup-fanout.md)
- [`credit-estimation.md`](./credit-estimation.md)
- [`dataforseo-metered-client.md`](./dataforseo-metered-client.md)
- [`live-queued-check-paths.md`](./live-queued-check-paths.md)
- [`mcp-tool-registration.md`](./mcp-tool-registration.md)
- [`pgStep.md`](./pgStep.md)
- [`r2-cache-key.md`](./r2-cache-key.md)
- [`rank-check-workflow.md`](./rank-check-workflow.md)
- [`research-scope-target-parser.md`](./research-scope-target-parser.md)
- [`run-lifecycle-guards.md`](./run-lifecycle-guards.md)
- [`sam-agent-turn-hooks.md`](./sam-agent-turn-hooks.md)
- [`schedule-anchor.md`](./schedule-anchor.md)
- [`scheduled-rank-checks-cron.md`](./scheduled-rank-checks-cron.md)
- [`serp-rankcheck-adapter.md`](./serp-rankcheck-adapter.md)
- [`site-audit-phases.md`](./site-audit-phases.md)
