...
**Not duplicated here:** Every individual linter rule — enable project-relevant rules from Effective Dart links. Flutter widget layout — use stack capsules in `knowledge/foundations`.
