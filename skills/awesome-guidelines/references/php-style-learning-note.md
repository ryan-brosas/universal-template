...
**Not duplicated here:** WordPress/Drupal/Magento CMS coding standards — use stack capsules in `knowledge/foundations` when CMS is known. Full SOLID treatise — capsules capture review probes only.
