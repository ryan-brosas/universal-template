...
**Not duplicated here:** WordPress/Drupal/Magento CMS coding standards — use stack capsules in `skills/*-foundation` when CMS is known. Full SOLID treatise — capsules capture review probes only.
