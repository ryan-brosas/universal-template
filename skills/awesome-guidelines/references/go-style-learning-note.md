...
**Not duplicated here:** Standard project layout (directory scaffolding) — adopt per repo; not a style invariant. RPC/framework specifics — use stack capsules in `knowledge/foundations`.
