...
**Not duplicated here:** Rails/RSpec style guides — use `knowledge/foundations` when framework is known. Full hash-literal spacing debates — project RuboCop config wins.
