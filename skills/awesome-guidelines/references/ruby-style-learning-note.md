...
**Not duplicated here:** Rails/RSpec style guides — use `skills/*-foundation` when framework is known. Full hash-literal spacing debates — project RuboCop config wins.
