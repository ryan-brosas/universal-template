...
**Not duplicated here:** TypeScript domain modeling — `typescript-coding-standards`. React/component patterns — `knowledge/foundations/react`. HTML/CSS — `frontend-markup-practices`.
