...
**Not duplicated here:** TypeScript domain modeling — `typescript-coding-standards`. React/component patterns — `skills/react-foundation`. HTML/CSS — `frontend-markup-practices`.
