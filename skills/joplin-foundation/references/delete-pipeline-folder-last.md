...
**Probe:** `bash -c 'cd /mnt/hdd/utopia/inspo/joplin && grep -cF "await Folder.markNotesAsConflict(folderId);" packages/lib/Synchronizer.ts && grep -cF "deleteChildren: false," packages/lib/Synchronizer.ts && grep -cF "error.code === '"'"'isReadOnly'"'"'" packages/lib/services/synchronizer/utils/syncDeleteStep.ts'` (anchored at repo root; expects 1 / ≥1 / 1). Direct tests: `Synchronizer.basics.test.ts` delete family (:108-262 incl. cross-delete-all-folders).
