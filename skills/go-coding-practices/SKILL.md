...
Application skill for Go style learning (`awesome-guidelines` deep ingest). For service layout or framework patterns, follow project conventions and stack foundations.
