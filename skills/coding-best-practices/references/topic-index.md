...
| Documentation | `documentation-and-readme.md` | `markdown-writing-practices`, `google-devdocs-practices` (developer guides), `mailchimp-content-practices` (user-facing copy), `templates/readme.md`, `workflow-lifecycle` init |
