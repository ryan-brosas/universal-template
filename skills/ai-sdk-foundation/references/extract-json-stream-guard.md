...
**Probe:** `bash -c "grep -c SUFFIX_BUFFER_SIZE /mnt/hdd/utopia/inspo/ai/packages/ai/src/middleware/extract-json-middleware.ts && grep -c 'Object.create(null)' /mnt/hdd/utopia/inspo/ai/packages/ai/src/util/create-id-map.ts"` → `4` and `1`.
