...
## Provenance
smolagents (Apache-2.0), `main@30bb1161095dbae2271e6bc3cc4c219cc3897a57`; Codebase Memory project `smolagents` (root `$REFERENCE_ROOT/smolagents`, FULL mode re-indexed 2026-08-25T20:09:04Z at HEAD, 2,756n/11,037e, parse_partial only examples/open_deep_research/requirements.txt:2-2, tests/data + __pycache__ excluded by design). Passes 1+ predate the ledger and cite the now-dead project `ext-smolagents` (root `$REFERENCE_ROOT/external/smolagents`, since removed) — same pin; pass 2 (2026-08-25) re-indexed under the short name and reconciled counts to 40 refs. Work record: `inspo/smolagents-work/{state,research,verification}.md`.
