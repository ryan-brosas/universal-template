...
- `./service-result-aggregation.md` — one combined outcome for composed services without exceptions.
- `./base-callable-state-pipeline.md` — argument normalization plus shared side-channel state threading.
- `./contracted-stage-ladder.md` — ordered success-gated validate → transform → persist pipeline.
- `./transactional-service-context.md` — rollback-by-result-value, advisory-lock serialization, execute-as-user.
- `./writable-attribute-permission-reduction.md` — declarative writable surface reduced by conditions then per-user permissions.
- `./changed-by-system-attribution.md` — distinguishing user-caused from calculated changes in one pass.
- `./wp-derived-attribute-plane.md` — param-plane ordering, date/duration derivation algebra, semantic-id move safety.
- `./wp-update-cascade-consolidation.md` — fanning out while saving each record once (one journal entry).
...
- [`base-callable-state-pipeline.md`](./base-callable-state-pipeline.md)
- [`changed-by-system-attribution.md`](./changed-by-system-attribution.md)
- [`contracted-stage-ladder.md`](./contracted-stage-ladder.md)
- [`service-result-aggregation.md`](./service-result-aggregation.md)
- [`transactional-service-context.md`](./transactional-service-context.md)
- [`wp-derived-attribute-plane.md`](./wp-derived-attribute-plane.md)
- [`wp-update-cascade-consolidation.md`](./wp-update-cascade-consolidation.md)
- [`writable-attribute-permission-reduction.md`](./writable-attribute-permission-reduction.md)
