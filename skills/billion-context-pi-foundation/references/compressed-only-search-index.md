...
**Source:** billion-context-pi (MIT) `master@558a83a9db69`; Codebase Memory project `billion-context-pi`. **Question:** How do you build a search corpus over compressed history without re-indexing messages the model can still see?
