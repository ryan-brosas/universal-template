...
**Path/Symbol:** `src/index.ts`: `wireContextTransform` (`pi.on("context")`, :135-381).
...
### Decisive source
```ts
// index.ts:138-239 (pin 6a88c556) — mutex + config layering + sent-view tokenCount:
