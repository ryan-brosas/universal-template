...
**Probe:** `cd $REFERENCE_ROOT/billion-context-pi && npx tsx --test tests/integration.test.ts tests/sent-view-arbitration.test.ts` — 34/34 GREEN at pin 6a88c556 (executed pass 12; ref-tagging parity, omp tail-merge stability, sent-view scale pins).
**Retrieve:**
```ts
