...
**Probe:** `cd $REFERENCE_ROOT/billion-context-pi && npx tsx --test tests/sent-view-arbitration.test.ts tests/footer-status.test.ts tests/tokens.test.ts` — 16/16 GREEN at pin 6a88c556 (executed pass 12).
**Retrieve:**
```ts
