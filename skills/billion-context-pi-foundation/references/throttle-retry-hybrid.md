...
**Path/Symbol:** `src/throttle-retry.ts` whole (154L): `THROTTLE_RETRY_ERROR_MESSAGE` (:8), guards (:13-16), `isThrottleError` (:25-32), `isKickMessage` (:34-37), `resolveThrottleRetry` (:63-76), `throttleDelayMs` (:78-81), `ThrottleEpisode` (:91-144), `abortableSleep` (:146-154).
