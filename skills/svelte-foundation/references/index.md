...
- `./sources-write-path.md` — how does a write propagate dirtiness without recomputing anything?
- `./batch-flush-machine.md` — when do effects actually run relative to writes, and what bounds runaway loops?
- `./effect-root-scheduling.md` — how is an effect scheduled exactly once per flush, at its root?
- `./time-travel-batch-values.md` — how do concurrent async batches coexist without corrupting each other's view of state?
- `./derived-versioned-pull.md` — how are deriveds lazily recomputed with O(1) staleness checks?
- `./effect-tree-pause-resume.md` — how does the runtime keep the effect tree as a linked list and swap branches safely?
- `./prop-propagation-plane.md` — how do component props stay in sync with parent state without being signals themselves?
- `./store-subscription-effects.md` — how do `$store` auto-subscriptions bridge a callback world onto the signal graph?
- `./async-flatten-boundary.md` — how do `await` expressions suspend a batch without losing the reactive context?
- `./derived-freeze-unfreeze.md` — how do effects created inside a derived survive the derived losing all its readers?
- `./keyed-each-reconciliation.md` — how does a keyed list reorder, insert, and remove items with minimal DOM moves?
...
- [`async-flatten-boundary.md`](./async-flatten-boundary.md)
- [`batch-flush-machine.md`](./batch-flush-machine.md)
- [`derived-freeze-unfreeze.md`](./derived-freeze-unfreeze.md)
- [`derived-versioned-pull.md`](./derived-versioned-pull.md)
- [`effect-root-scheduling.md`](./effect-root-scheduling.md)
- [`effect-tree-pause-resume.md`](./effect-tree-pause-resume.md)
- [`keyed-each-reconciliation.md`](./keyed-each-reconciliation.md)
- [`prop-propagation-plane.md`](./prop-propagation-plane.md)
- [`sources-write-path.md`](./sources-write-path.md)
- [`store-subscription-effects.md`](./store-subscription-effects.md)
- [`time-travel-batch-values.md`](./time-travel-batch-values.md)
