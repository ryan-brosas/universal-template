...
## Canonical templates
Create every foundation leaf from the canonical loader/map structure and every new or substantively rewritten reference from the canonical capsule-v2 form, both in `references/foundation-templates.md`; portable copies live at `/home/utopia/.dsh/template/work/project/foundation-skill.md` and `/home/utopia/.dsh/template/work/project/foundation-capsule.md` (template-only library assets, not slash-command render targets). Do not invent a second leaf or reference layout.
