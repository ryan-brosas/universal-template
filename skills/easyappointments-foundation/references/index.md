...
## Provenance
easyappointments (GPL-3.0 — patterns only, never verbatim), `main@359c3649dc1977fa3fe882b422a462d77c8abce4`; Codebase Memory project `ext-easyappointments` (ready, root `$REFERENCE_ROOT/external/easyappointments`, branch main@same sha, 42,155 nodes / 57,424 edges, FULL mode, indexed gen 2026-08-23T11:45Z generation_matches=true; parse_partial = 88 files, all PHP views/SCSS/config-yaml templates — none cited here; skipped 0; not_indexed = images/fonts BY DESIGN).
