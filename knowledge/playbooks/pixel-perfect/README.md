---
title: pixel-perfect
summary: Use when a design copy must match its source pixel-perfectly — Paper↔Figma fidelity checks, fixing 'it looks off' or 'not accurate' feedback, verifying fills, radii, shadows, type metrics, or fonts against the design source, or before calling a design match done.
kind: playbook
---
