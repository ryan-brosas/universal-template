---
title: farmed-test-harness
summary: Use when writing tests for code that talks to HTTP/LLM/external services, reuse the farmed test harness (cassette recording/replay, client error handling, pytest fixtures) instead of writing tests from scratch.
kind: playbook
---
