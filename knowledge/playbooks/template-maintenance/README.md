...
summary: Use when auditing or maintaining this .agents/universal-template repository—especially failed or wrong skill selection, AGENTS.md, prompts, skills, templates, MCP declarations, or publication tooling; review semantics and run only relevant exact checks.
kind: playbook
---
