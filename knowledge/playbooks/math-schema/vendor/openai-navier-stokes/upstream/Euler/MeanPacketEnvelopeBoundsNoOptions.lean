...
theorem envelope_bounds_noOptions (E : SobolevData D ι q R)
  ...
  · subst A
    ...
    simp only [hzero.1, hzero.2.1, hzero.2.2, map_zero, block_zero_function, zero_mul, le_refl, implies_true, and_self]
