...
variable (J : JoinedInputs (A.meanData H) (A.transverseData m hm R S hS) τ hτ hτT (A.historyOn H m hm R S hS τ hτ hτT))
...
theorem joined_child_eventually :
    ∃ ρ0 γ Cw Cv Cp : ℝ, 0 < ρ0 ∧ 0 < γ ∧ 0 < Cw ∧ 0 < Cv ∧ 0 < Cp ∧
      ...
      ∃ (hk : 4 ≤ k) (hn : 1 ≤ truncation k)
        (Q : EulerAllOrderDriftCorrection.Budget period ((A.transverseData m hm R S hS)).T_pos
          (initializedCorrectionData (A.meanData H) (A.transverseData m hm R S hS) rfl τ hτ hτT (A.historyOn H m hm R S hS τ hτ hτT) δ hδ ξ hs α (A.sourceAgreement m hm R S hS H)
        ...
        G.A = Q.liftedPacketCoefficient period
          (initializedNormalizedField (A.meanData H) (A.transverseData m hm R S hS) rfl τ hτ hτT (A.historyOn H m hm R S hS τ hτ hτT) δ hδ ξ hs α (truncation k) k) ∧
        G.A₁ = Q.liftedPacketDerivativeCoefficient period
          (initializedNormalizedDerivativeField (A.meanData H) (A.transverseData m hm R S hS) rfl τ hτ hτT (A.historyOn H m hm R S hS τ hτ hτT) δ hδ ξ hs α (truncation k) k) ∧
        ...
        (∀ (t : Icc (0 : ℝ) A.T) (x : Space),
          ‖fderiv ℝ (initializedExactPhysicalVelocity (A.meanData H) (A.transverseData m hm R S hS) rfl τ hτ hτT (A.historyOn H m hm R S hS τ hτ hτT) δ hδ ξ hs α
            (A.sourceAgreement m hm R S hS H) (truncation k) hn k hk Q t (I.normalized t)) x -
            (α*deriv (profile δ) (k*⟪m,I.normalized t x⟫_ℝ)) •
              rankOne ℝ (canonicalVelocity τ hτ hτT (A.historyOn H m hm R S hS τ hτ hτT) ξ hs t (I.normalized t x))
                (((A.transverseData m hm R S hS)).normal.field t (I.normalized t x))‖ < Cv/k ∧
          ‖fderiv ℝ (gradient (initializedExactPhysicalPressure (A.meanData H) (A.transverseData m hm R S hS) rfl τ hτ hτT (A.historyOn H m hm R S hS τ hτ hτT) δ hδ ξ hs α
            (A.sourceAgreement m hm R S hS H) (truncation k) hn k hk Q t (I.normalized t))) x -
            (EulerPacketPrimaryPressure.coefficient τ hτ hτT (A.historyOn H m hm R S hS τ hτ hτT) ξ hs α t (I.normalized t x) *
  ...
  obtain ⟨ρ0,γ,Cw,Cv,Cp,hρ,hγ,hCw,hCv,hCp,hsource⟩ :=
    initialized_child_label_bounds_eventually (A.meanData H) (U := U) (A.transverseData m hm R S hS) rfl τ hτ hτT (A.historyOn H m hm R S hS τ hτ hτT) δ hδ hδ1 ξ hs α hα
