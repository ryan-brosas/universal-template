---
title: pdf-extract
summary: Use when extracting text, images, tables, or metadata from PDF files. MUST load to choose the correct extraction library based on PDF complexity, simple text vs structured data vs complex layouts.
kind: playbook
---
