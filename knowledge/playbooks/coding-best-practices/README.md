...
summary: Use when the user asks for engineering standards, coding best practices, quality guidance, or the applicable quality procedure. Route to the narrowest language/framework leaf or gate; not for ordinary implementation.
kind: playbook
---
...
2. Scope control, maintainability, verification discipline, or design judgment
   routes to `../code-discipline/README.md`.
3. Test design routes to `../test-generation/README.md`,
   `../test-driven-development/README.md`, or
   `../testing-anti-patterns/README.md` according to the request.
4. Security review routes to `../security-and-hardening/README.md`. Turning a
   stable exact practice into automation routes to `../practices-to-ci/README.md`.
5. Completion evidence routes to `../agent-code-quality-gate/README.md`; PR
   delivery routes to `../push-pr/README.md`. Neither is implied by a general
   standards question.
6. Skill authoring routes to `../writing-skills/README.md`; template-repository
   maintenance also loads `../template-maintenance/README.md`.
