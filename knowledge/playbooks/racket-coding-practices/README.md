---
title: racket-coding-practices
summary: Use when authoring or reviewing Racket, DrRacket indent, kebab-case naming, define/cond/for idioms, provide/contract-out modules, rackunit tests, and raco test in CI.
kind: playbook
---
