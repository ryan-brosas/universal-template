 ...
 *   - listLearnings / learnings       : registry over knowledge/playbooks/cdp/learnings/<domain>/
...
const HELP: Record<string, string> = {
  ...
  listLearnings: 'listLearnings() -> string[]. Domains under knowledge/playbooks/cdp/learnings/.',
