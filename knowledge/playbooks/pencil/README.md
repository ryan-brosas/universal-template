---
title: pencil
summary: Use when copying a Figma frame, component set, variables, or visual reference into Paper with literal source fidelity.
kind: playbook
---
...
`../paper-component-consistency/README.md`. For Paper platform mechanics, themes/CSS
variables, clipboard import, and new capabilities, load `../paper-design/README.md`.
...
- **Reuse built work.** Inspect relevant Paper specimens and page patterns before
  ...
  (`../paper-component-consistency/README.md`). Build only missing/divergent parts.
...
- `references/mcp.md`: MCP probe order, published-library access, provenance checks, and partial-operation recovery.
