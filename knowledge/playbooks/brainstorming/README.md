---
title: brainstorming
summary: Use when a rough idea needs clarification before implementation, resolve ambiguous direction by grounding in what exists, framing the problem, exploring real alternatives, and deciding.
kind: playbook
---
...
- **potential durable recovery, handoff, compliance, or coordination need** → explicitly load `../goal-setup/README.md` to qualify the record; duration alone is not a gate
...
- `../prototype/README.md`, cheap runnable learning
- `../goal-setup/README.md`, earned recovery or coordination state
