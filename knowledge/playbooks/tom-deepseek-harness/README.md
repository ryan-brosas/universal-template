---
x-manual-only: true
title: tom-deepseek-harness
summary: 'Use when working on Tom''s DeepSeek Harness source checkout: update from Tom''s remote, edit safely, build, run the source web app, and keep the installed DSH separate.'
kind: playbook
---
