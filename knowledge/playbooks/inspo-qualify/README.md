---
title: inspo-qualify
summary: 'Use when an active project needs external GitHub prior art: assess one candidate from relevant source; acquire a checkout or create an index only when useful and explicitly authorized.'
kind: playbook
---
...
`../goal-setup/README.md` to qualify the record, timing, and project-native location.
...
- `../codebase-memory/README.md`, index lifecycle and source-of-truth limits
- `../reference-driven-development/README.md`, prior-art selection and direct-test discipline
- `../leverage-capture/README.md`, earned promotion classification
