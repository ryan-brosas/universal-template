...
summary: Use when preparing to merge, deploy, release, or declare a development branch complete.
kind: playbook
---
...
hosts, transactional mutation guards live in `knowledge/playbooks/fabric-native-execution/`
