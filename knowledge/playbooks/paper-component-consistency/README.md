---
title: paper-component-consistency
summary: Use when a reusable component in Paper must be created, audited, instantiated, migrated, or synchronized across pages while preserving intentional variants and content.
kind: playbook
---
...
- `../pencil/README.md`: literal transfer; `../pixel-perfect/README.md`: fidelity diagnosis.
- `../prototype/README.md`: exploration before shared rules are established.
