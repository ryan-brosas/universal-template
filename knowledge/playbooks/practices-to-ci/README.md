---
title: practices-to-ci
summary: Use when a recurring, objective failure may deserve an automated check; reuse existing project gates before adding a custom validator or CI step.
kind: playbook
---
...
`../test-generation/README.md` covers catch-first test design.
`../github-actions-engineering/README.md` covers workflow integration when needed.
