...
summary: Use when capture is explicitly requested, a hard procedure recurs, or an expensive failure or milestone yields a concrete reusable candidate; classify it into code, references, foundations, gates, skills, project notes, or nothing.
kind: playbook
---
