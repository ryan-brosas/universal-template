...
For applying project branding to a duplicate, use `../../paper-project-branding/README.md`. This workflow does not require a new import or a parallel token system.
