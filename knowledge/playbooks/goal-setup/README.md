---
title: goal-setup
summary: Use when recovery, handoff, compliance, or external coordination needs durable work state that source, Git, the tracker, and session history cannot cheaply preserve.
kind: playbook
---
...
may be explicitly routed to `../leverage-capture/README.md`.
