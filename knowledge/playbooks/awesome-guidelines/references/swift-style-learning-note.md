...
**Not duplicated here:** Full SwiftFormat rule matrix — project formatter config wins on indent (spaces vs tabs). SwiftUI/UIKit patterns — use stack capsules in `knowledge/foundations`.
