...
**Not duplicated here:** TypeScript/React/component frameworks — see `typescript-coding-standards`, `knowledge/foundations/react`, stack capsules in `knowledge/foundations`.
