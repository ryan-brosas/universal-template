...
**Not duplicated here:** Spring/EE stack patterns — use `knowledge/foundations` when stack is known. Full Alibaba layer naming (DO/DTO/VO) — optional enterprise convention, not universal.
