...
**Not duplicated here:** Full API guidelines checklist (100+ items) — capsules cover highest-leverage public-API seams. Async/concurrency deep dives — stack capsules in `knowledge/foundations` when needed.
