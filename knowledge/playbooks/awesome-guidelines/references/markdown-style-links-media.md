...
**Flow:** wrap the phrase that describes destination — not "here" or bare URL → internal docs use explicit path `/docs/...md` → same-directory relative OK → avoid `../../../../skills` chains → reference links when URL disrupts 80-col flow.
