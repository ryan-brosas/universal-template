...
summary: Use when a task or delegated lane needs a concrete model or backend; inspect live availability, choose the smallest sufficient option, probe uncertainty, and escalate only from observed gaps.
kind: playbook
---
...
- `../execution-router/README.md`, when execution shape must be chosen first.
- `../veda-lane/README.md`, native Veda lane execution.
