...
- Source record: `continue`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@5522c6f44ca0ac3528b37244818fbfa39b5af470`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Pipeline & caching; Streaming & reuse; Prompt & token
  budget; Output safety; Static & next-edit; Snippet gathering & streaming
  internals; Token accounting; Next-edit context plane.
