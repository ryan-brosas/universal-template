...
- `./fast-recorder-gate-decision.md` — who wins: user setting vs sticky disable vs probe.
- `./fast-recorder-sticky-disable-ttl.md` — self-healing device-disable lifecycle.
- `./fast-recorder-probe-cache-single-flight.md` — TTL cache + coalesced probing.
- `./encoder-roundtrip-support-ladder.md` — config ladder + real encode round-trip.
- `./fast-recorder-output-validation-taxonomy.md` — hardFail vs informational verdicts.
- `./webcodecs-in-session-fallback-swap.md` — silent engine swap mid-recording.
- `./first-chunk-watchdog-evidence-ladder.md` — rearm ladder over recorder snapshots.
- `./recorder-start-gate-timeout-race.md` — deferred start that re-checks at the timeout tick.
- `./telemetry-bg-forward-survival.md` — tab→BG relay so events outlive window.close().
- `./telemetry-store-write-chain.md` — BG ring store: chained RMW, never-throw, mirror key.
- `./upload-telemetry-fan-in-hub.md` — the one emit point: id ladders, store-always/network-selective.
- `./telemetry-request-allowlist-fold.md` — typed allowlist, pre-mediaId diag admission, errMsg fold.
- `./telemetry-network-send-ladder.md` — token ladder, beacon-first unload sends, 404/405/413 kill switch.
- `./session-status-two-machine-split.md` — uploader-resume set vs session-recovery set.
- `./stale-journal-post-crash-sweep.md` — destroy resume identity before a fresh session.
- `./crash-recovery-download-then-clear.md` — backend-aware rescue: download → delayed revoke → clear.
...
- [`crash-recovery-download-then-clear.md`](./crash-recovery-download-then-clear.md)
- [`encoder-roundtrip-support-ladder.md`](./encoder-roundtrip-support-ladder.md)
- [`fast-recorder-gate-decision.md`](./fast-recorder-gate-decision.md)
- [`fast-recorder-output-validation-taxonomy.md`](./fast-recorder-output-validation-taxonomy.md)
- [`fast-recorder-probe-cache-single-flight.md`](./fast-recorder-probe-cache-single-flight.md)
- [`fast-recorder-sticky-disable-ttl.md`](./fast-recorder-sticky-disable-ttl.md)
- [`first-chunk-watchdog-evidence-ladder.md`](./first-chunk-watchdog-evidence-ladder.md)
- [`recorder-start-gate-timeout-race.md`](./recorder-start-gate-timeout-race.md)
- [`session-status-two-machine-split.md`](./session-status-two-machine-split.md)
- [`stale-journal-post-crash-sweep.md`](./stale-journal-post-crash-sweep.md)
- [`telemetry-bg-forward-survival.md`](./telemetry-bg-forward-survival.md)
- [`telemetry-network-send-ladder.md`](./telemetry-network-send-ladder.md)
- [`telemetry-request-allowlist-fold.md`](./telemetry-request-allowlist-fold.md)
- [`telemetry-store-write-chain.md`](./telemetry-store-write-chain.md)
- [`upload-telemetry-fan-in-hub.md`](./upload-telemetry-fan-in-hub.md)
- [`webcodecs-in-session-fallback-swap.md`](./webcodecs-in-session-fallback-swap.md)
