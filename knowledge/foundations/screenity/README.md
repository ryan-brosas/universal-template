...
- Source record: `screenity`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `master@e10e375fafa1680de99ca6db36536dd4a1f4f7d4`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Gate decision; Sticky disable TTL; Probe cache;
  Encoder ladder; Output validation; Fallback swap; Watchdog; Start gate.
