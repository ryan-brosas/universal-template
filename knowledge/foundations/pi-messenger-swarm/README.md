...
- Source record: `pi-messenger-swarm`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@6fe429a4b74ae276a621bb72910d7926fb6b3104`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Channel & feed storage; Registry & identity; Task
  engine; Subagent lifecycle; Harness daemon & transport; Host integration;
  TUI overlay plane.
