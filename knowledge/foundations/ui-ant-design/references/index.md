...
- `./token-computed-ladder.md` — how runtime tokens are computed, cached, and how per-component themes recurse.
- `./designtoken-sync-parity.md` — computing tokens outside React while staying equal to the hook path.
- `./alias-format-token.md` — precedence contract and special-case folding in the alias layer.
- `./algorithm-composition.md` — derivative signature, mapToken short-circuit, dark/compact deltas.
- `./palette-index-ladder.md` — what palette[1..10] means for every status color; neutral ladders; radius clamps.
- `./cssvar-naming-contract.md` — CSS-var naming, fallbacks, unitless classes, reset-style injection.
- `./component-token-externals.md` — public vs `@internal` component tokens; derivation-only defaults algebra (Table-proven, repo-wide ×61 convention).
- `./style-hook-registration.md` — genStyleHooks registration, mergeToken `table*` second alias layer, per-component unitless/reset options.
- `./fixed-shadow-contract.md` — fixed-column two-plane shadows, z-index CSS-var algebra, rc-table boundary.
- `./rtl-shadow-mirror.md` — direction layer swaps shadow sides without regenerating primitives.
- `./table-size-ladder.md` — small/medium density builder with calc-derived compensating margins.
- `./nested-border-cssvar.md` — publish/consume/reset custom-property protocol for self-nesting components.
- `./token-to-layout-consumption.md` — one ComponentToken feeding both CSS and JS layout defaults; props win by spread order.
...
- [`algorithm-composition.md`](./algorithm-composition.md)
- [`alias-format-token.md`](./alias-format-token.md)
- [`component-token-externals.md`](./component-token-externals.md)
- [`cssvar-naming-contract.md`](./cssvar-naming-contract.md)
- [`designtoken-sync-parity.md`](./designtoken-sync-parity.md)
- [`fixed-shadow-contract.md`](./fixed-shadow-contract.md)
- [`nested-border-cssvar.md`](./nested-border-cssvar.md)
- [`palette-index-ladder.md`](./palette-index-ladder.md)
- [`rtl-shadow-mirror.md`](./rtl-shadow-mirror.md)
- [`style-hook-registration.md`](./style-hook-registration.md)
- [`table-size-ladder.md`](./table-size-ladder.md)
- [`token-computed-ladder.md`](./token-computed-ladder.md)
- [`token-to-layout-consumption.md`](./token-to-layout-consumption.md)
