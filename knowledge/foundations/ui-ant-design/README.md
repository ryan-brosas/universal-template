...
- Source record: `ui-ant-design`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `master@977d8e037a4841bb847b8a40ffd1f79b23264826`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Token computation; Sync parity; Alias layer;
  Algorithms; Palettes; CSS vars; Component-token externals; Style-hook
  registration.
