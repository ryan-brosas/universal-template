...
- Source record: `localterm`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `f26c5853`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Bash-secret defense; Terminal stack; Session
  management; Headless rendering & persistence; Agent extension; CLI
  ergonomics; Agent automation; Git & UX surfaces.
