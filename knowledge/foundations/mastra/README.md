...
- Source record: `mastra`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@502653550fb45d8e72dfdd57732161f9176dbcf2`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Workflow Engine & State Machine; Snapshot Persistence
  & Pruning; Runtime State & Wire Boundary; Stream Plane; Agent Runtime &
  Memory Isolation; External Events; Graph RAG & Reranking; Protocol & SDK
  Bridges.
