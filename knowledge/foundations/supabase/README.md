...
- Source record: `supabase`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `master@a18253f7c7d3a967bf91599c9dcf8ae704b7d686`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Typed client kernel (data/fetchers.ts); Transport +
  identity; Empty-body normalizer; Middleware pair; Error classification;
  Legacy + SQL planes; Dual fetch plane; SQL guard ladder.
