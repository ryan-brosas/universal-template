...
- Source record: `pi-provider-kimi-code`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@794330400343d6f0cd0059635187b233c4d90273`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Payload mutation pipeline; File-upload IO edge;
  Upload memo cache; Schema type back-fill; Tool schema dedup; Empty-response
  filter; Stream auth retry; Layered config merge ladder.
