...
- Source record: `linkforty-core`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@8919b1ecdc48f8c53340c4590b5f0eae0680abf8`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Redirect decision; Click accounting; Safety gate;
  Schema probe; Scheme handoff; Flagged-page XSS; Install attribution; Bot
  flagging.
