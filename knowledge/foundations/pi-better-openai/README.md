...
- Source record: `pi-better-openai`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@1188f985389328cff660b6bdbe52f38fdb826c70`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Config; Fast mode; Auth; Usage parsing; Redaction;
  Live wire codec; Live chunking; Live retry.
