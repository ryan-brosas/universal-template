...
- Source record: `open-seo`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@cd6a782092556d6f7a0e3ab1cdb66a4dada30e28`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Workflow kernel; Rank tracking; DataForSEO adapter;
  Shared infra; AI measurement; Site audit; Agent surfaces.
