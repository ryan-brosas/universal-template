...
- Source record: `open-webui`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@01f4282f1ffe0d6212f58d3afbeae21fffd0c4be`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Config store; Event bus; Socket events; Hybrid
  retrieval; Plugin loader; Filter pipeline; Agentic tool loop; Stream tag
  scanner.
