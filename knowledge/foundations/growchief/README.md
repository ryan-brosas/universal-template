...
- Source record: `growchief`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@abb1e37a6f5595d8d105aef5871a2eeb0c22a1dc`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Orchestration; Scheduling; Enrichment; Browser;
  Contracts; Extensibility; Extraction; Evasion-adjacent.
