...
- Source record: `penpot`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `develop@64a52d6b`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Change system; Transform engine; Storage; History;
  Scene tree; Primitives; File migrations; Compatibility.
