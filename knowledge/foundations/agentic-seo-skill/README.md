...
- Source record: `agentic-seo-skill`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@69199160e18372bc5cdf9ddec20ccb9fb1b509f1`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Transport kernel; Parsing kernel; Crawl policy;
  Report gate; AI measurement; Schema plane; Content intelligence; Rank
  tracking.
