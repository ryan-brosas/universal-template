...
- Source record: `humanizer`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@e2e92e7b4b8229253ed5c8e81dc65463fdeddda5`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Prompt-corpus plane; Package-validation plane;
  Distribution/CI plane.
