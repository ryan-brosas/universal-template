...
- Source record: `ultireaaach`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@60bf4a3e478022df11ed2f04077d129f4f72cc60`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Loopback control plane; SSRF-fenced rewrite proxy;
  Cloud-API mock; Total name-heuristic mock; Run FSM + durable counters;
  Dedup-or-merge lead store; Extension bridge bootstrap; PAS launcher-RPC shim.
