...
- Source record: `pi-fabric`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `feat/veda-runner@4874ac3abefab27ee0064a3c8571ee017ceb3115`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Mutation guard; Actor supervision; Actor safety &
  identity; Agent launching; Trajectory & cost; Supervisor process; Sandboxing
  & security; Infra kernels.
