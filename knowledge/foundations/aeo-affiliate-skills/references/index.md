...
- `./cli-daemon-reuse-ladder.md` — how does a thin CLI get ~100ms responses by reusing a daemon it may have to start?
- `./daemon-idle-self-lifecycle.md` — how does the daemon own its port, state file, and idle shutdown without leaking either?
- `./ttl-cache-key-namespacing.md` — how are responses cached across requests, and which results must never be cached?
- `./wide-page-client-filter.md` — how do you support filters the upstream API cannot evaluate server-side?
- `./registry-invariant-pipeline.md` — how does a markdown skill corpus stay in verified sync with registry.json?
- `./doc-vocabulary-contract-tests.md` — how do you stop field-name drift between docs, client code, and a renamed upstream?
- `./pattern-grep-skill-evals.md` — how do you behavior-test prompt-skills with zero test framework?
- `./agent-self-install-bootstrap.md` — how does an agent skill install and build its own tool on first use?
...
- [`agent-self-install-bootstrap.md`](./agent-self-install-bootstrap.md)
- [`cli-daemon-reuse-ladder.md`](./cli-daemon-reuse-ladder.md)
- [`daemon-idle-self-lifecycle.md`](./daemon-idle-self-lifecycle.md)
- [`doc-vocabulary-contract-tests.md`](./doc-vocabulary-contract-tests.md)
- [`pattern-grep-skill-evals.md`](./pattern-grep-skill-evals.md)
- [`registry-invariant-pipeline.md`](./registry-invariant-pipeline.md)
- [`ttl-cache-key-namespacing.md`](./ttl-cache-key-namespacing.md)
- [`wide-page-client-filter.md`](./wide-page-client-filter.md)
