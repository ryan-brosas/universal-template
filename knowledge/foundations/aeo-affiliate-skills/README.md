...
- Source record: `aeo-affiliate-skills`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@ed17ef37bc167b52d9596cbe0292507f001c483d`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Daemon-backed CLI; Daemon self-lifecycle; Shared TTL
  cache; Client-side filter adapter; Registry pipeline; Doc contract tests;
  Skill eval harness; Self-install bootstrap.
