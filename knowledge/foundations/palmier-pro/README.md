...
- Source record: `palmier-pro`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@49841f35b3eafa65c7eadc7b168bcc74db632906`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Agent runtime; Provider clients; Tool plane; MCP
  surface; Skills; Project persistence.
