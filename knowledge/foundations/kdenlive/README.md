...
- Source record: `kdenlive`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `master@62d6b0b79c51438705ca310b2178f422c1f31fe1`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Undo functor kernel; Move validation ladder; Group
  two-phase move; Track insertion ownership; Insertion functor ladder; Groups
  forest; Snap plane; Resize proposal.
