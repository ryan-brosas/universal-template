...
- Source record: `twenty-crm`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@9e4717278c29efa3ba0c147f6acf0d68e99a625c`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Zero-Downtime Upgrade Plane; Multi-Tenant ORM &
  Security; Error Handling & Diagnostics; Dynamic Schema & DDL Engine; Caching
  & Hydration; Record Ordering & Position; Upsert Engine; Tool-Facing CRUD
  Surface.
