...
- `./pbkdf2-verification-kernel.md` — how a server verifies a client-derived secret without ever seeing the password.
- `./jwt-issuer-realms.md` — one RSA keypair serving ten non-interchangeable token lifetimes via issuer suffixes.
- `./refresh-rotation-ladder.md` — JWT validity → DB device-token existence → auth-method/config gate, and what kills the chain.
- `./stamp-exception-grace.md` — route-scoped 2-minute grace window that lets password changes not log out the actor.
- `./guard-chain-rbac.md` — Rocket FromRequest ladder encoding member/admin/manager/owner in types.
- `./trusted-proxy-client-ip.md` — peer-trust-gated header parsing with IPv4-mapped canonicalization.
- `./ratelimit-three-lanes.md` — governor limiters for login/admin/unauthenticated with startup-fail config.
- `./password-login-ladder.md` — exact gate order of /connect/token password grant incl. auth-request bypass.
- `./twofactor-challenge-envelope.md` — TwoFactorProviders2 challenge JSON, provider usability gates, remember tokens.
- `./totp-replay-ledger.md` — last-used time-step high-water mark making 30-second codes single-use.
- `./register-invitation-ladder.md` — stub accounts, consume-on-read invitations, dual wire-shape compat fold.
- `./lazy-kdf-upgrade.md` — verify-then-ratchet work-factor migration without an offline rehash job.
- `./key-rotation-fanout.md` — validate-first re-encryption fan-out, notification suppression, honest non-atomicity.
- `./org-recovery-reset.md` — public-key escrow enrollment → admin reset with pre-mutation notification gate.
- `./send-access-ladder.md` — typed error taxonomy plus atomic conditional-UPDATE access counters.
- `./egress-ssrf-guard.md` — blocking hooks at parse, every DNS answer, and every redirect hop.
- `./error-taxonomy-macros.md` — one Error carrying user/log split, code, event, silence; client-shaped envelopes.
- `./make-config-layered-engine.md` — declarative table generating env/file/panel merging with file-over-env precedence and privacy masking.
- `./sso-reconciliation-ladder.md` — identifier-first OIDC matching with explicit refusal taxonomy and refresh-time revocation.
- `./timing-sidechannel-posture.md` — which channels are closed, masked, or accepted, documented in-source.
- `./security-header-fairing.md` — central response hook with per-route CSP/CORP/X-Frame exceptions.
- `./mpolicy-merge.md` — commutative max/OR policy reduction plus the shared protected-action proof struct.
- `./device-handshake-authrequest.md` — approve-then-redeem passwordless login pinned to request IP + 5-minute TTL.
- `./emergency-recovery-codes.md` — burn-on-use recovery codes and time-delayed escrow handover.
- `./admin-session-gate.md` — purpose-isolated admin realm, fixed short TTL, own rate-limit lane.
- `./retry-db-helpers.md` — two-cadence retry twins where zero means wait forever at boot.
...
- [`admin-session-gate.md`](./admin-session-gate.md)
- [`device-handshake-authrequest.md`](./device-handshake-authrequest.md)
- [`egress-ssrf-guard.md`](./egress-ssrf-guard.md)
- [`emergency-recovery-codes.md`](./emergency-recovery-codes.md)
- [`error-taxonomy-macros.md`](./error-taxonomy-macros.md)
- [`guard-chain-rbac.md`](./guard-chain-rbac.md)
- [`jwt-issuer-realms.md`](./jwt-issuer-realms.md)
- [`key-rotation-fanout.md`](./key-rotation-fanout.md)
- [`lazy-kdf-upgrade.md`](./lazy-kdf-upgrade.md)
- [`make-config-layered-engine.md`](./make-config-layered-engine.md)
- [`mpolicy-merge.md`](./mpolicy-merge.md)
- [`org-recovery-reset.md`](./org-recovery-reset.md)
- [`password-login-ladder.md`](./password-login-ladder.md)
- [`pbkdf2-verification-kernel.md`](./pbkdf2-verification-kernel.md)
- [`ratelimit-three-lanes.md`](./ratelimit-three-lanes.md)
- [`refresh-rotation-ladder.md`](./refresh-rotation-ladder.md)
- [`register-invitation-ladder.md`](./register-invitation-ladder.md)
- [`retry-db-helpers.md`](./retry-db-helpers.md)
- [`security-header-fairing.md`](./security-header-fairing.md)
- [`send-access-ladder.md`](./send-access-ladder.md)
- [`sso-reconciliation-ladder.md`](./sso-reconciliation-ladder.md)
- [`stamp-exception-grace.md`](./stamp-exception-grace.md)
- [`timing-sidechannel-posture.md`](./timing-sidechannel-posture.md)
- [`totp-replay-ledger.md`](./totp-replay-ledger.md)
- [`trusted-proxy-client-ip.md`](./trusted-proxy-client-ip.md)
- [`twofactor-challenge-envelope.md`](./twofactor-challenge-envelope.md)
