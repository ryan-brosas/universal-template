...
- Source record: `pi-autoresearch`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@511760df8905c7b6e6bbd3a028de734becff69e6`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Persistence kernel; Statistics; Loop lifecycle;
  Benchmark execution; Git isolation; Agent-loop control; Extensibility
