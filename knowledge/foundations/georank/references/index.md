...
- `./reservation-ledger.md` — two-phase reserve→settle kernel; conditional UPDATE holds.
- `./principal-merge.md` — lock→re-read→merge of user/device quota principals.
- `./provider-stage-idempotency.md` — per-stage claim leases; completed spend is append-only.
- `./cjk-token-estimator.md` — CJK 1-char/token heuristic; 3× reservation headroom; module floors.
- `./byok-contract.md` — X-BYOK header protocol; configured-origin pinning; transient keys only.
- `./ssrf-pinned-provider-http.md` — shape gate + resolve-verify + connect-time re-pin transport.
- `./provider-failover-ladder.md` — providers→primary→fallback tiers; blank output IS failure; buffered streaming.
- `./geo-diagnostic-scoring.md` — schema/meta/content/citation scorers + weighted fusion + degraded recommender twin.
- `./pipeline-stage-claims.md` — error-column epoch lease; resume-after-crash re-dispatch.
- `./task-finalize-boundary.md` — final-attempt detection; reservation-scoped terminal writes; broker-vs-business retries.
- `./access-resolution-trio.md` — sync vs queued vs system AI authorization contexts.
- `./reservation-expiry-sweeper.md` — piggy-backed SKIP LOCKED sweep; midnight-clamped async expiry.
- `./usage-recording-settlement.md` — event converges to settled charge; BYOK events excluded from quota.
- `./knowledge-page-selection.md` — weighted-keyword nav ranking; homepage always first; LLM-or-heuristic parity.
- `./ssrf-safe-crawl.md` — per-request URL revalidation inside Playwright routing.
- `./crawl-persist-verify.md` — put+read-back gate before advancing pipeline state.
- `./graph-write-guard.md` — closed ontology validation + company-scoped MERGE + idempotent rebuilds.
- `./vector-store-degradation.md` — embed-skip vs count-mismatch fail; replace-set upserts; centroid similarity.
- `./keyword-expansion-profiles.md` — profile inference, hash-stable scores, template fallback with AI-path output parity.
- `./settings-overlay-normalizer.md` — DB-over-env config builders; enum defaults; PG-int clamps; TTL cache.
- `./encrypted-settings-aad.md` — AES-GCM envelope with setting-name AAD defeating row swaps.
- `./profile-replace-semantics.md` — replace-vs-merge field mapping; provider-failure shield over heuristic base.
- `./retrieval-fallback-scoring.md` — script-aware tokenization and weighted-field lexical ranking.
...
- [`access-resolution-trio.md`](./access-resolution-trio.md)
- [`byok-contract.md`](./byok-contract.md)
- [`cjk-token-estimator.md`](./cjk-token-estimator.md)
- [`crawl-persist-verify.md`](./crawl-persist-verify.md)
- [`encrypted-settings-aad.md`](./encrypted-settings-aad.md)
- [`geo-diagnostic-scoring.md`](./geo-diagnostic-scoring.md)
- [`graph-write-guard.md`](./graph-write-guard.md)
- [`keyword-expansion-profiles.md`](./keyword-expansion-profiles.md)
- [`knowledge-page-selection.md`](./knowledge-page-selection.md)
- [`pipeline-stage-claims.md`](./pipeline-stage-claims.md)
- [`principal-merge.md`](./principal-merge.md)
- [`profile-replace-semantics.md`](./profile-replace-semantics.md)
- [`provider-failover-ladder.md`](./provider-failover-ladder.md)
- [`provider-stage-idempotency.md`](./provider-stage-idempotency.md)
- [`reservation-expiry-sweeper.md`](./reservation-expiry-sweeper.md)
- [`reservation-ledger.md`](./reservation-ledger.md)
- [`retrieval-fallback-scoring.md`](./retrieval-fallback-scoring.md)
- [`settings-overlay-normalizer.md`](./settings-overlay-normalizer.md)
- [`ssrf-pinned-provider-http.md`](./ssrf-pinned-provider-http.md)
- [`ssrf-safe-crawl.md`](./ssrf-safe-crawl.md)
- [`task-finalize-boundary.md`](./task-finalize-boundary.md)
- [`usage-recording-settlement.md`](./usage-recording-settlement.md)
- [`vector-store-degradation.md`](./vector-store-degradation.md)
