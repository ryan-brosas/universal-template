...
- Source record: `ell`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@9d129846203e75efeb4e5cddd3fb1c164dc0b243`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Decorator pipeline; Traced strings; Message model;
  Tools; Provider SPI; Provider SPI / config; Versioning; Tracking.
