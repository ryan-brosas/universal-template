...
- Source record: `agno`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@9644f22982ae017eaa4ad85c561d927d9ac03119`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Run spine; Plan state; Autonomy loop; Cancellation;
  Message bus; Backpressure; Tool routing; Background work.
