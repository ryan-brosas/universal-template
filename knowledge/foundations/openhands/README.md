...
- Source record: `openhands`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@8511fff62d3084587cda1add483fe5ea9c8bfd7e`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Conversation stream kernel; Reconnect ladder; Delta
  batcher; Event store; Optimistic queue; Cron preset mapping; Client-tool
  round trip; Dev-stack orchestrator.
