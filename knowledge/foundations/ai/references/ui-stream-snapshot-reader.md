...
**Probe:** `bash -c "grep -c textByPartIndex $REFERENCE_ROOT/ai/packages/ai/src/ui-message-stream/read-ui-message-stream.ts && grep -n 'exclude accumulated text from structured cloning' $REFERENCE_ROOT/ai/packages/ai/src/ui-message-stream/read-ui-message-stream.test.ts && grep -n 'already closed' $REFERENCE_ROOT/ai/packages/ai/src/ui-message-stream/read-ui-message-stream.ts"` → `3`, `:241`, `:110`.
