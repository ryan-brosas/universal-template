...
- Source record: `agent-s`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@bffdb59c60cbbb38c3a190b2e91da12039e4063c`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Worker spine; Code delegation; LLM plumbing;
  Grounding & actions; Trajectory judging (BoN); Local execution.
