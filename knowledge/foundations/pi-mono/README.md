...
- Source record: `pi-mono`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@80e62761f7251a104f1b21d9c73920c720f0ec00`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: EventStream kernel; Provider retry ladder; Agent loop
  semantics; Compaction trigger & safe cut; Repeated compaction; Branch
  summarization; Anthropic message normalization; Anthropic wire-compat ladder.
