...
- Source record: `cognee`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@a8f9760b`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Cognify routing; Task engine; Chain core; Run engine;
  Incremental skip; Rollback; Background anchoring; Dataset lock.
