...
- Source record: `qodana-action`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@e0675fbe6aeb`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Arg surface; CLI lifecycle; Caching; PR mode;
  Orchestration; Output; Interaction; Write-back.
