...
- Source record: `tanstack-query`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@bc423b37ef7fa2a34cfc7286945fd640d74b4071`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Fetch retry kernel; Fetch dedup ladder; Query
  reducer; Optimistic fetchState; Cache hashing; Key prefix matching;
  Structural sharing; Sharing policy gate.
