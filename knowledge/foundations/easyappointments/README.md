...
- Source record: `easyappointments`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@359c3649dc1977fa3fe882b422a462d77c8abce4`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Availability kernel; Break plane; Group services;
  Booking windows; Conflict enforcement; Any-provider; Webhooks; API auth.
