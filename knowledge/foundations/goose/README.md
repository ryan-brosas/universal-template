...
- Source record: `goose`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@2eb3ab1001dedb5ab09a6ed60158adfc248bac56`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Retry/backoff ladder; Provider error taxonomy;
  Provider trait + stream fold; Sanitized message model; Think-tag stream
  filter; Thinking-effort negotiation; Prompt-cache semantics; Request logger
  SPI.
