...
- Source record: `pi-hypercharm-provider`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@4520704`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Catalog sync; Merge pipeline; Grace period; Usage
  tee; Settle barrier; Account fetch; Polling gate; Optimistic balance.
