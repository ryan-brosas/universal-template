...
- `./source-priority-pipeline.md` — how are sources ordered and folded so earlier sources win?
- `./current-state-visibility.md` — how do custom sources coordinate during one resolution?
- `./env-field-resolution.md` — which env var names map to which field key, in what precedence?
- `./complex-env-value-pipeline.md` — JSON decode vs delimiter explode vs plain string?
- `./dotenv-extras-contract.md` — what happens to .env vars matching no declared field?
- `./secrets-dir-contract.md` — how are secret dirs scanned, ordered, and decoded?
- `./file-config-sources.md` — how do JSON/TOML/YAML sources get alias-aware keys?
- `./cli-source-wiring-priority.md` — how does a CLI source join the pipeline and where does it rank?
- `./cli-parser-adapter-inheritance.md` — how does a CLI source reuse the env pipeline and drive any parser?
- `./cli-field-arg-descriptor.md` — how does one typed field become exactly one parser argument?
- `./cli-parsed-list-merge.md` — what happens when one flag is repeated/comma/JSON/k=v?
- `./cli-bool-flag-modes.md` — how are booleans exposed as explicit/dual/toggle flags?
- `./cli-app-subcommand-runtime.md` — how does a model run as an app with subcommands and async commands?
...
- [`cli-app-subcommand-runtime.md`](./cli-app-subcommand-runtime.md)
- [`cli-bool-flag-modes.md`](./cli-bool-flag-modes.md)
- [`cli-field-arg-descriptor.md`](./cli-field-arg-descriptor.md)
- [`cli-parsed-list-merge.md`](./cli-parsed-list-merge.md)
- [`cli-parser-adapter-inheritance.md`](./cli-parser-adapter-inheritance.md)
- [`cli-source-wiring-priority.md`](./cli-source-wiring-priority.md)
- [`complex-env-value-pipeline.md`](./complex-env-value-pipeline.md)
- [`current-state-visibility.md`](./current-state-visibility.md)
- [`dotenv-extras-contract.md`](./dotenv-extras-contract.md)
- [`env-field-resolution.md`](./env-field-resolution.md)
- [`file-config-sources.md`](./file-config-sources.md)
- [`secrets-dir-contract.md`](./secrets-dir-contract.md)
- [`source-priority-pipeline.md`](./source-priority-pipeline.md)
