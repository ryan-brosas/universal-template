...
- Source record: `veda`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `master@c3c69f2c340ec81ada8ea974076ce5bbaf5ccbc6`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Verification; Model resolution; Ensemble;
  Persistence; Deep pipeline; Judging; Prompt portfolio; Backend transport.
