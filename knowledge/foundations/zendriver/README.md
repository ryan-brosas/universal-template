...
- Source record: `zendriver`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@2c6d9c7daaab543d34e9fe2b0ef7eaa171c79760`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Protocol core; Launch & config; Session & targets;
  Query & elements; Input & automation; Network & stealth.
