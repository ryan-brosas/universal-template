...
**Probe:** `bash -c 'cd $REFERENCE_ROOT/joplin && grep -cF "new JoplinError('"'"'Lock has expired'"'"', '"'"'lockExpired'"'"')" packages/lib/services/synchronizer/LockHandler.ts && grep -n "void this.cancel()" packages/lib/Synchronizer.ts | wc -l'` (anchored at repo root; expects `1` then ≥1 line containing `void this.cancel()` at :583).
