...
**Probe:** `cd $REFERENCE_ROOT/billion-context-pi && npx tsx --test tests/throttle-retry.test.ts` — 26/26 GREEN at pin 6a88c556 (executed pass 12) incl. relay-shape/direct-Bedrock classification, overflow/quota rejection, the full "3 native + kick + 3 native + kick + exhaustion" timeline, reset semantics, and delay math.
**Retrieve:**
```ts
