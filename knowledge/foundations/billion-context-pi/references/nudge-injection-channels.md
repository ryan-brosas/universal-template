...
**Probe:** `cd $REFERENCE_ROOT/coding-agents/billion-context-pi && npx tsx --test tests/compress-retry.test.ts tests/tokens.test.ts` — GREEN at pin (cap reachability incl. emergency loop case; turnKey derivation). Line anchors grep-verified at pass-4 pin: :296/:305-313/:314/:321-322.
**Retrieve:**
```ts
