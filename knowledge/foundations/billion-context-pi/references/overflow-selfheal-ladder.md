...
**Probe:** `cd $REFERENCE_ROOT/billion-context-pi && npx tsx --test tests/overflow-selfheal.test.ts` — 21/21 GREEN at pin 6a88c556 (executed pass 12; window parse per provider phrasing, marker superset vs Bedrock-throttle non-match, headroom reservation matrix).
**Retrieve:**
```ts
