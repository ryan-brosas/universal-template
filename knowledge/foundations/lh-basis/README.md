...
- Source record: `lh-basis`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `?@? (non-Git curated source)`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Identity type algebra; Hash id decoding; Guard kernel
  composition; Template node tree; List payload shapes; Collision error
  mining; Source-scoped schemas; Organization identifiers.
