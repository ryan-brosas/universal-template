...
- Source record: `visx`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `master@485c0359664ee8e612992defb16e1f035ed40b23`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Scale plane; A11y plane; Brush plane; Interaction
  plane; Responsive plane; Text plane; Spring plane; Kernel plane.
