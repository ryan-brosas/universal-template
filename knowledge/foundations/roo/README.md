...
- Source record: `roo`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@b867ec9145750d0ae1ff7f02d35406e9bf2a0b16`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Safety & approvals; Personas & tools; Loop
  resilience; Context plane (non-destructive history); State & UI; State & UI
  (multi-instance history); Native tool-call streaming & protocol; Config
  plane.
