...
- Source record: `pi-fovea`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@5bd4e6f5c56190fb174245266464607b11f7a337`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Heat kernel; CSR operator; Renderer; Literal joins;
  Sync gate; Co-change; Anchor pack; Discovery.
