...
- Source record: `ufo`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@96983c73ed09e884a5f1d7ff8936c953b234b684`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Ready-task claim loop; Two-copy DAG state merge;
  Modification wait, fail-open; Cancellation ladder; Error funnel; DAG
  validation; Dependency-condition promotion; Round state-machine pump.
