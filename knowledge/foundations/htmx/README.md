...
- Source record: `htmx`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `master@ad56dff71e55d9c717447437b4c942a64575d4b2`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Attribute semantics; Parsing plane; Trigger runtime;
  Data plane; Request plane; Response & swap; Lifecycle & infra.
