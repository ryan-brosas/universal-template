...
- Source record: `copilotkit`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@e9387e04835545c45744b791aee7c9c03520be31`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Agent Run Loop & Event Fanout; Delivery Error &
  Promise Boundaries; UI Actions & State Rehydration; Channel Formatting & UI
  AST; Telegram Transport Plane; Discord Transport Plane; Teams Transport
  Plane; Teams Rendering Plane.
