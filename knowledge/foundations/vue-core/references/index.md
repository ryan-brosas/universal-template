...
- `./dep-link-graph.md` — how are many-to-many dep↔subscriber edges stored, re-used, and torn down without leaks?
- `./batch-queue.md` — how are same-tick notifications coalesced, ordered, and drained exactly once?
- `./effect-lifecycle.md` — what flags/stack discipline keep tracking, recursion, pause, and stop correct?
- `./computed-pull-model.md` — when does a computed re-evaluate, propagate, and stay cached (chained)?
- `./effect-scope-tree.md` — how do effects get disposed together, paused/resumed, detached safely?
- `./base-handlers.md` — how do reads track, writes trigger, and identity checks avoid false triggers?
- `./reactive-factory.md` — when does a value become a proxy, and which quadrant's proxy comes back?
- `./collection-instrumentations.md` — how do Map/Set/Weak* become reactive via get-only redirection?
- `./array-instrumentations.md` — which array methods need ARRAY_ITERATE tracking, raw-search retry, untracked mutations?
- `./trigger-fanout.md` — which implicit deps (ITERATE/length/array-iterate) must each mutation type wake?
- `./ref-model.md` — how do refs wrap values, unwrap on set, and link to reactive properties?
- `./proxy-refs.md` — minimal one-level unwrap proxy with write-through-to-ref semantics.
- `./base-watch.md` — source normalization + forceTrigger + job gating for watch/watchEffect.
...
- [`array-instrumentations.md`](./array-instrumentations.md)
- [`base-handlers.md`](./base-handlers.md)
- [`base-watch.md`](./base-watch.md)
- [`batch-queue.md`](./batch-queue.md)
- [`collection-instrumentations.md`](./collection-instrumentations.md)
- [`computed-pull-model.md`](./computed-pull-model.md)
- [`dep-link-graph.md`](./dep-link-graph.md)
- [`effect-lifecycle.md`](./effect-lifecycle.md)
- [`effect-scope-tree.md`](./effect-scope-tree.md)
- [`proxy-refs.md`](./proxy-refs.md)
- [`reactive-factory.md`](./reactive-factory.md)
- [`ref-model.md`](./ref-model.md)
- [`trigger-fanout.md`](./trigger-fanout.md)
