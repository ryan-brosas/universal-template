...
- Source record: `relaticle`; portable upstream identity, license, coverage caveats, and retrieval history are preserved in the index.
- Recorded revision: `main@6e3bf8dfb7c5dcc97765fcba6fdf62585c541e1b`.
- Full provenance, coverage caveats, boundaries, and preserved evidence:
  `references/index.md`.

## Topic map

- Representative topics: Import scratch storage; Import mapping & resolution;
  Import execution & bulk writes; Custom fields metadata & validation; AI chat
  orchestration & safety; Billing & MCP tool surface; Agent-loop economics;
  Billing transfer (sysadmin).
