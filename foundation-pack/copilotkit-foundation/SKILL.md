...
- `references/telegram-long-poll-loop-guard.md` — never await a blocking agent step inside grammY long getUpdates poll (callback deadlock, silent drain); fire-and-forget turns; ack-first callbacks; reaction echo loop guard.
