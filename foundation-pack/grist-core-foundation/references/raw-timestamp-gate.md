...
**Probe:** `bash -c 'cd /mnt/hdd/utopia/inspo/platforms/grist-core && grep -n "\\/\\^\\[1-9\\]" app/common/parseDate.ts && grep -n "parseTimeStamp(date)" app/common/parseDate.ts'` → :445 regex and both call sites :113/:160.
