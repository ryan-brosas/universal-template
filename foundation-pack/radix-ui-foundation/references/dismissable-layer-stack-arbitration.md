...
**Probe:** direct tests `packages/react/dismissable-layer/src/dismissable-layer.test.tsx` :68-280 (outside/inside/prevented/focus/branch/defer/shadow cases). Byte-exact anchor: `bash -c "cd /mnt/hdd/utopia/inspo/external/ui-radix-ui && grep -nF 'We purposefully prevent combining this effect' packages/react/dismissable-layer/src/dismissable-layer.tsx"` (:205).
**Retrieve:**
```ts
